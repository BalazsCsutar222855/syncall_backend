...
SECRET_KEY = 'django-insecure-@=+_gm-t*g^_)e0ko=_y!vy@$1+_x0#pd^b07vy91f5(40&78o'
...
ROOT_URLCONF = 'syncall_backend.urls'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'syncal_database',       # Replace with your database name
        'USER': 'admin',           # Replace with your database user
        'PASSWORD': 's9HMY8]dgF0!Wpxa',   # Replace with your database password
